...
1. Give proper formated path of the input file in 'invoke.m' file. As I had to calculate features for 1000 images I took a loop.
The file names should be in such a format that they can be iterated in a loop.
